...
public class PopupContainerWithArrow extends AbstractFloatingView implements DragSource, DragController.DragListener {
    ...
    final class PopupContainerAnimator extends AnimatorListenerAdapter {
        PopupContainerAnimator() {
        }
    ...
    final class PopupContainerAnimatorItem extends AnimatorListenerAdapter {
        PopupContainerAnimatorItem() {
        }
    ...
    final class PopupContainerAnimatorView extends AnimatorListenerAdapter {
        PopupContainerAnimatorView() {
        }
    ...
    private void animateOpen() {
        ...
        createAnimatorSet.addListener(new PopupContainerAnimator());
    ...
    public void trimNotifications(Map map) {
        if (mNotificationItemView != null) {
            ...
            if (badgeInfo == null || badgeInfo.getNotificationKeys().size() == 0) {
                ...
                duration2.addListener(new PopupContainerAnimatorItem());
    ...
    protected void animateClose() {
        if (mIsOpen) {
            ...
            createAnimatorSet.play(duration);
            createAnimatorSet.addListener(new PopupContainerAnimatorView());
            mOpenCloseAnimator = createAnimatorSet;
            createAnimatorSet.start();
