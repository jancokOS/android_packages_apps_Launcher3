...
public class NotificationFooterLayout extends FrameLayout {
    ...
    final class NotificationAnimationListener extends AnimatorListenerAdapter {
        NotificationAnimationListener() {
        }
    ...
    private void removeViewFromIconRow(View view) {
        ...
        if (mIconRow.getChildCount() == 0) {
            ...
            if (open != null) {
                ...
                reduceNotificationViewHeight.addListener(new NotificationAnimationListener());
