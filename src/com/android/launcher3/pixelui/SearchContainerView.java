...
public class SearchContainerView extends QsbView
{
    private static final Rect sTempRect = new Rect();
    private final TransformingTouchDelegate mTouchDelegate;

    public SearchContainerView(Context paramContext)
    {
        this(paramContext, null);
    }

    public SearchContainerView(Context paramContext, AttributeSet paramAttributeSet)
    {
        this(paramContext, paramAttributeSet, 0);
    }

    public SearchContainerView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
    {
